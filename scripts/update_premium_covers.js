...
const newImages = [
  {
    ...
    sourcePath: "C:/Users/Leonardo/.gemini/antigravity/brain/3917a1ca-fae4-45d5-9d38-69c39c381134/azzaro_wanted_premium_bg_1777842720854.png",
    destFilename: "azzaro_wanted_premium_bg.webp"
  },
  {
    name: "Bvlgari Pour Homme",
    folder: "bvlgari_pour_homme",
    sourcePath: "C:/Users/Leonardo/.gemini/antigravity/brain/3917a1ca-fae4-45d5-9d38-69c39c381134/bvlgari_pour_homme_premium_bg_1777842734383.png",
    destFilename: "bvlgari_pour_homme_premium_bg.webp"
  },
  {
    name: "Carolina Herrera CH Men",
    folder: "ch_men",
    sourcePath: "C:/Users/Leonardo/.gemini/antigravity/brain/3917a1ca-fae4-45d5-9d38-69c39c381134/ch_men_premium_bg_1777842748145.png",
    destFilename: "ch_men_premium_bg.webp"
  }
];
...
async function run() {
  ...
  for (const item of newImages) {
    ...
    try {
      console.log(`Optimizing AI image with ffmpeg to WebP...`);
  ...
  console.log("\nDone updating covers with premium AI backgrounds.");
  process.exit(0);
}
