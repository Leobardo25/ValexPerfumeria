...
export default function Gallery() {
    return (
        <section id="gallery" className="relative py-24 sm:py-32 bg-brand-dark">
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                    {galleryImages.map((src, i) => (
                        <div
                            key={i}
                            className="group aspect-[3/4] rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-brand-gold/10 border border-brand-dark transition-all duration-500 hover:scale-[1.03] cursor-pointer"
                        >
